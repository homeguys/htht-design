...
/* 在线天地图URL配置 */
export const onLineTdtLayers_w = {
...
export const onLineTdtLayers_c = {
...
/* 在线google地图URL配置 */
export const onLineGoogleLayers = {
...
/* 在线高德地图URL配置 */
export const onLineGaodeLayers = {
