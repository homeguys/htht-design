import { productEnum } from '../enum/product_enum'

export const ELECONFIG = {
  NDVI: {
    url: 'http://192.168.1.81:16080/geoserver/wsfTest/wms',
    layerName: 'wsfTest:NDVI'
  },
  TVDI: {
...
* ele：样式名
* */
export function returnEleStyle (ele,opacity=1) {
